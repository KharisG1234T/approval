    ...
    barangs.forEach((item, no) => {
      ...
      $('#dynamic').append(`
        <tr id="row${no}" class="tb_row">
          ...
          <td><input type="text" id="sku${no}" placeholder="SKU" value="${item.sku}" class="form-control" required /></td>
          <td><input type="text" id="stokpo${no}" placeholder="Stok/PO" value="${item.stok_po}" class="form-control" required /></td>
